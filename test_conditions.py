...
if __name__ == '__main__':
    ...
    dates2 = [
        '想要去欧洲度蜜月，大概10天左右',
        '找个欧洲无购物的，适合两个人，大概十一出行',
        '有没有7月份适合亲子游的产品',
        '想带着老人孩子暑期出趟国，带他们见见世面',
        '想去东南亚玩，大概七八天，有什么好的推荐？',
        '找个国内适合情侣游玩的地方，最好是安静些的，五一左右出发。',
        '有没有适合家庭出游的海滨城市，适合六月去的？',
        '想在国庆期间去个能放松身心的地方，国内国外都行，有什么建议？',
        '打算去日本旅游，大概一周时间，有没有适合年轻人的玩法？',
        '找个适合带父母去的温泉胜地，最好是在北方，冬季去。',
        '有没有适合闺蜜一起去的海岛，适合四月去度假的？',
        '想在暑假带孩子去个能增长知识的地方，国内有哪些选择？',
        '打算春节期间出国旅游，有没有适合一家人去的温暖的地方？',
        '找个适合一个人去旅行的地方，能让自己沉淀一下，时间大概是半个月左右。',
        '想找个能看绝美星空的地方，预算不高，周末就能去，有推荐吗？',
        '想年底和朋友一起跨年旅行，有没有热闹又有特色的城市？',
        '想带孩子去个能亲近大自然，还能寓教于乐的地方，暑假出发。',
        '有没有小众但风景超美的国内古镇，适合慢悠悠游玩三五天？',
        '想找个能滑雪又能泡温泉的地方，春节期间出行，求推荐。',
        '计划和同事组团旅游，有没有适合团建，能增进感情的地方？',
        '有没有适合老年人疗养的海边城市，气候舒适，住一个月左右。',
        '想找个能体验异域风情的边境小城，预算有限，短假期可去。',
        '求推荐适合大学生穷游的地方，有美食、有美景，交通方便。',
        '想找个能深度感受历史文化的地方，适合自由行，玩一周左右。',
    ]
